...
import { businessIdeaSessionSchema } from '@/lib/business-idea/schema';
  ...
  try {
    ...
    return new Response(
      JSON.stringify({
        ...
        businessIdeaBrief: session.businessIdeaBrief,
...
export async function PATCH(
  ...
  try {
    ...
    if (action === 'approve') {
      const updatedSession = businessIdeaSessionSchema.parse({
        ...session,
        status: 'approved',
        businessIdeaBrief: {
          ...session.businessIdeaBrief,
